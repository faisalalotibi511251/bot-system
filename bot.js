...
client.on("ready", () => {
    var guild;
    while (!guild)
        guild = client.guilds.find("name", "! Myths.")
...
client.on('message', function(message) {
    ...
    .addField("# - Apply User:",mUser,true)
    .addField("# - Apply User ID:",mUser.id,true)
    .addField("# - Experience:",messageReason,true)
    .addField("# - Time:",message.createdAt,true)
    .setFooter("The Myths Bot")
...
antispam(client, {
  ...
  maxBuffer: 5,
  interval: 1000,
  warningMessage: ":warning: | وقف ولا بنعطيك ميوت.",
  roleMessage: "Muted!!",
  roleName: "Muted",
